	...
	block_type_data = [
		{
			...
			[$variable_block_position_1.position, $variable_block_position_2.position],
		...
		},
		{
			"name": "tee",
			"variable_block_positions":
			[$variable_block_position_2.position, $variable_block_position_4.position],
		...
		},
		{
			"name": "l_right",
			"variable_block_positions":
			[$variable_block_position_3.position, $variable_block_position_5.position],
			"rotation_center": $rotation_center_2,
		...
		},
		{
			"name": "l_left",
			"variable_block_positions":
			[$variable_block_position_1.position, $variable_block_position_5.position],
			"rotation_center": $rotation_center_2,
			"initial_offset": Vector2(0, -48)
		},
		{
			"name": "zag_right",
			"variable_block_positions":
			[$variable_block_position_3.position, $variable_block_position_2.position],
			"rotation_center": $rotation_center_2,
			"initial_offset": Vector2(0, -16)
		},
		{
			"name": "zag_left",
			"variable_block_positions":
			[$variable_block_position_1.position, $variable_block_position_4.position],
			"rotation_center": $rotation_center_2,
			"initial_offset": Vector2(0, -16)
		},
		{
			"name": "line",
			"variable_block_positions":
			[$variable_block_position_5.position, $variable_block_position_6.position],
